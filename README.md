...
A map of my public work — systems design, AI architecture, platform tooling, and independent research.
 
I'm a Product Manager building complex enterprise platforms by day. Independently, I work at the intersection of AI systems architecture and consumer software.
 
---
 
## Start here
 
If you're new, start with one of these depending on what brought you here:
 
- **Event governance & distributed systems** → [Systems of Trust Series](https://github.com/rtfenter/Systems-of-Trust-Series)
- **Loyalty & platform systems** → [Loyalty Systems Series](https://github.com/rtfenter/Loyalty-Systems-Series)
- **AI & ML UX prototypes** → [AI & ML UX Systems Series](https://github.com/rtfenter/AI-ML-UX-Systems-Series)
- **AI systems & architecture** → [Applied Intelligence Systems Series](https://github.com/rtfenter/Applied-Intelligence-Systems-Series)
- **Independent research** → [RIA Research Notes](https://github.com/rtfenter/RIA-Research-Notes)
...
# 5. Recursive Identity Architecture (RIA)  
